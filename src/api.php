...
$host = "descartographiedb.mysql.db";
$dbname = "descartographiedb";
$user = "descartographiedb";
$mdp = "123456789";
        ...
        if ($_POST['key'] == "POAJFF8AH20F221NJHP30") {           
            if ($_POST["action"] == "getSavedPaths") {
                ...
                if (isset($_SESSION["user"])) {
                    ...
                    $client_id = "SECRET_CHARACTER_STRING_HERE.apps.googleusercontent.com";
...
if (isset($_GET["code"])) {
    $client_id = "SECRET_CHARACTER_STRING_HERE.apps.googleusercontent.com";
    $client = new Google_Client(['client_id' => $client_id]);
    $client->setAuthConfig("google/client_secret_SECRET_CHARACTER_STRING_HERE.apps.googleusercontent.com.json");
